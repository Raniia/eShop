...
<tr>
<td colspan="3" id = "msg">
You have successfully bought these items!</td>
</tr>
...
$total += $sumprice;
	...
	$products_in_buy= "SELECT * FROM buy where  cid = $customerID";
$run_products_in_buy = mysqli_query($con , $products_in_buy);
while ($prod = mysqli_fetch_array($run_products_in_buy)) {
	$pid2 = $prod['pid'];
...
<tr align="center">
<td><input class = "myButton" type="submit" name = "view" value="View History "/></td> </th>
<td><input class = "myButton" type="submit" name = "shop" value="Back to products"/></td> </th>
